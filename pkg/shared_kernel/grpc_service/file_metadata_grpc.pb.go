...
func (c *fileMetadataServiceClient) CreateDirectory(ctx context.Context, in *CreateDirectoryRequest, opts ...grpc.CallOption) (*DirectoryInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DirectoryInfo)
	err := c.cc.Invoke(ctx, FileMetadataService_CreateDirectory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterFileMetadataServiceServer(s grpc.ServiceRegistrar, srv FileMetadataServiceServer) {
	// If the following call panics, it indicates UnimplementedFileMetadataServiceServer was
...
func _FileMetadataService_GetDirectories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(FileMetadataServiceServer).GetDirectories(ctx, in)
	}
...
func _FileMetadataService_CreateDirectory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateDirectoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileMetadataServiceServer).CreateDirectory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileMetadataService_CreateDirectory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileMetadataServiceServer).CreateDirectory(ctx, req.(*CreateDirectoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileMetadataService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "file_metadata.FileMetadataService",
	HandlerType: (*FileMetadataServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetDirectories",
			Handler:    _FileMetadataService_GetDirectories_Handler,
		},
		{
